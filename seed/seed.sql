...
INSERT INTO expenses (id, name, value, category_id, "group", date, user_id, user_name) VALUES (2, 'Test expense 2', 240, 2, 'Test group', CURRENT_TIMESTAMP, 'localhost/testuser2', 'Test user 2');
